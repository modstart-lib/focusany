...
import { WorkflowActionCode } from './plugin/workflow/action'
import { WorkflowPlugin } from './plugin/workflow'
...
export const ManagerSystem = {
    ...
    async list() {
        const plugins: (PluginRecord | any)[] = [SystemPlugin, StorePlugin, WorkflowPlugin, getAppPlugin, getFilePlugin]
