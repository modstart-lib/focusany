        ...
        <div class="flex-grow h-full overflow-y-auto p-4" v-if="recordCurrent">
            <div class="flex items-center">
                ...
                <div class="ml-3 flex items-center">
                    <a-button v-if="recordCurrent.name!=='system'"
                              type="primary" class="ml-1" status="danger" size="small"
                              @click="doUninstall">
                        卸载
                    </a-button>
                    <a-dropdown
                        v-if="recordCurrent.runtime&&recordCurrent.type===PluginType.DIR">
                        ...
                        <template #content>
                            ...
                            <a-doption v-if="developerPlugins.includes(recordCurrent.name)"
                                       @click="doPublish">
                                发布插件
                            </a-doption>
                            <a-doption v-if="developerPlugins.includes(recordCurrent.name)"
            ...
            <div v-if="actionTab==='match'">
                ...
                <div
                    ...
                    <div
                        v-for="m in a.matches.filter(m=>['regex','image','file'].includes((m as ActionMatchBase).type))"
                        class="mr-1 mb-1 inline-block">
                        <a-dropdown>
                            <a-button-group>
