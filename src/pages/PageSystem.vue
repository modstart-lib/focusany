        ...
        <div class="w-48 flex-shrink-0 border-r border-solid border-default h-full p-3 overflow-y-auto select-none">
            ...
            <div>
                <div class="flex items-center leading-10 py-1 px-1 rounded-lg cursor-pointer"
                     @click="tab='setting'"
                     :class="tab==='setting'?'bg-gray-200 dark:bg-gray-500':'hover:bg-gray-100 dark:hover:bg-gray-600'">
                    <img class="w-6 h-6 object-contain mr-2 ml-2 dark:invert" :src="SystemIcons.pluginSystem"/>
                    功能设置
                </div>
                <div class="flex items-center leading-10 py-1 px-1 rounded-lg cursor-pointer"
                     @click="tab='plugin'"
                     :class="tab==='plugin'?'bg-gray-200 dark:bg-gray-500':'hover:bg-gray-100 dark:hover:bg-gray-600'">
                ...
                <div class="flex items-center leading-10 py-1 px-1 rounded-lg cursor-pointer"
                     @click="tab='file'"
                     :class="tab==='file'?'bg-gray-200 dark:bg-gray-500':'hover:bg-gray-100 dark:hover:bg-gray-600'">
                    <img class="w-6 h-6 object-contain mr-2 ml-2 dark:invert" :src="SystemIcons.folder"/>
                    文件启动
                </div>
                <div class="flex items-center leading-10 py-1 px-1 rounded-lg cursor-pointer"
                     @click="tab='launch'"
                     :class="tab==='launch'?'bg-gray-200 dark:bg-gray-500':'hover:bg-gray-100 dark:hover:bg-gray-600'">
                ...
                <div>
                    <div class="flex items-center leading-10 py-1 px-1 rounded-lg cursor-pointer"
                         @click="tab='data'"
                         :class="tab==='data'?'bg-gray-200 dark:bg-gray-500':'hover:bg-gray-100 dark:hover:bg-gray-600'">
                        <img class="w-6 h-6 object-contain mr-2 ml-2 dark:invert" :src="SystemIcons.database"/>
                        数据中心
                    </div>
                    <div class="flex items-center leading-10 py-1 px-1 rounded-lg cursor-pointer"
                         @click="tab='about'"
                         :class="tab==='about'?'bg-gray-200 dark:bg-gray-500':'hover:bg-gray-100 dark:hover:bg-gray-600'">
