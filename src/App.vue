...
window.__page.onPluginCodeInit((data: { plugin: PluginRecord; type: 'list' | never; placeholder: string }) => {
...
window.__page.onPluginCodeSetting((data: { loading?: boolean; error?: string; placeholder?: string }) => {
...
window.__page.onPluginCodeData((data: { items: { id: string; [key: string]: unknown }[] }) => {
    // console.log('main.onPluginCodeData', data);
