...
import { default as EmbeddingModelLogo, default as EmbeddingModelLogoDark } from './assets/image/models/embedding.png'
...
import { default as GoogleModelLogo, default as GoogleModelLogoDark } from './assets/image/models/google.png'
...
import { default as MinicpmModelLogo, default as MinicpmModelLogoDark } from './assets/image/models/minicpm.webp'
...
export const SystemModels: Record<string, Partial<Model>[]> = {
    ...
    openai: [
        ...
        { id: 'gpt-4o', provider: 'openai', name: 'GPT-4o', group: 'GPT 4o', caps: { vision: true, tools: true } },
        {
            id: 'gpt-4o-mini',
            provider: 'openai',
            name: 'GPT-4o-mini',
        ...
        { id: 'o1-mini', provider: 'openai', name: 'o1-mini', group: 'o1', caps: { tools: true } },
        { id: 'o1-preview', provider: 'openai', name: 'o1-preview', group: 'o1', caps: { tools: true } },
    ],
    'azure-openai': [
        {
            id: 'gpt-4o',
    ...
    yi: [
        { id: 'yi-lightning', name: 'Yi Lightning', provider: 'yi', group: 'yi-lightning', caps: { tools: true } },
        { id: 'yi-vision-v2', name: 'Yi Vision v2', provider: 'yi', group: 'yi-vision', caps: { vision: true } },
    ],
    zhipu: [
        {
            id: 'glm-zero-preview',
    ...
    bailian: [
        ...
        { id: 'qwen-turbo', name: 'qwen-turbo', provider: 'dashscope', group: 'qwen-turbo', caps: { tools: true } },
        { id: 'qwen-plus', name: 'qwen-plus', provider: 'dashscope', group: 'qwen-plus', caps: { tools: true } },
        { id: 'qwen-max', name: 'qwen-max', provider: 'dashscope', group: 'qwen-max', caps: { tools: true } },
    ],
    stepfun: [
        {
            id: 'step-1-8k',
